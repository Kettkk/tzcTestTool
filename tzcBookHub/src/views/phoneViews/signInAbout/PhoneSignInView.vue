...
<template>
  <div>
    <div id="textContainer">
      <div id="Title1">开启刷题之旅</div>
      <div id="EnTitle">Sign in</div>
    </div>
      ...
      <div id="inputer">
        ...
        <div id="passwordContainer">
          <input
              ...
              id="customInput"
          />
          <button type="button" id="toggleButton" @click="togglePasswordVisibility">
